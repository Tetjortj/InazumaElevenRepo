...
public class Card {
    ...
    public Card(
        ...
        this.fp = fp;
        this.tp = tp;
        this.kick = normalizarPuntaje(kick);
        this.body = normalizarPuntaje(body);
        this.control = normalizarPuntaje(control);
        this.guard = normalizarPuntaje(guard);
        this.speed = normalizarPuntaje(speed);
        this.stamina = normalizarPuntaje(stamina);
        this.guts = normalizarPuntaje(guts);
        this.move1 = move1;
        this.move2 = move2;
        this.move3 = move3;
        this.move4 = move4;
